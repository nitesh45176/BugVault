        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <input name="title" defaultValue={bug.title} className={inputCls} required />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <textarea name="context" defaultValue={bug.context} className={`${inputCls} min-h-[100px]`} />
              </div>
              <div>
                <label className={labelCls}>Root Cause</label>
                <textarea name="rootCause" defaultValue={bug.rootCause} className={`${inputCls} min-h-[100px]`} />
              </div>
            </div>
